...
public class Problem112
{
	...
	/**
	 * Returns true if n is 'bouncy'
	 * @param n The number to test. Must be greater than 0.
	 * @return true if n is bouncy, false if n is increasing or decreasing.
	 */
	public static boolean isBouncy(int n)
	{
		...
		{
			int curDigit = n % 10;
			int curDirection = (lastDigit - curDigit);
			if (curDirection != 0)
			{
				if (direction != 0 && (curDirection ^ direction) < 0)
				{
					return true;
				}
				lastDigit = curDigit;
